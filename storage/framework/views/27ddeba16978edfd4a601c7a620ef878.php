    ...
    <div class="cart-layout">
        ...
        <div class="cart-side">
            <div class="cart-summary-box">
                ...
                <a href="<?php echo e(route('checkout.index')); ?>" class="btn btn-add">Proceed to Checkout &rarr;</a>
                <?php else: ?>
                
                <a href="<?php echo e(route('login', ['redirect' => route('checkout.index')])); ?>" class="btn btn-add">Log in to Checkout &rarr;</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
