...
@section('title', 'NovelPoint — A Haven for Every Bibliophile')
...
<section id="products">
    ...
    <form method="GET" action="{{ route('home') }}#products" class="search-form" id="shopForm">
        ...
        <div class="shop-layout {{ $hasActiveFilters ? 'has-sidebar' : '' }}" id="shopLayout">

            <div class="filters-backdrop" id="filtersBackdrop"></div>

            <!-- Filter Sidebar -->
            <aside class="filters-sidebar {{ $hasActiveFilters ? 'active' : '' }}" id="filtersSidebar">
                ...
                <div class="filters-actions">
                    <a href="{{ route('home') }}#products" class="btn-clear-filters">Clear All</a>
                </div>
                        ...
                        <div class="filter-options-list">
                            ...
                            <label class="filter-option">
                                <input type="checkbox" name="category[]" value="{{ $cat->CategoryID }}"
                                    @checked(in_array($cat->CategoryID, $selectedCategories))>
                        ...
                        <div class="filter-options-list">
                            ...
                            <label class="filter-option">
                                <input type="checkbox" name="author[]" value="{{ $author }}"
                                    @checked(in_array($author, $selectedAuthors))>
                                <span>{{ $author }}</span>
                            </label>
                            @endforeach
                        </div>
                        ...
                        <div class="filter-options-list">
                            ...
                            <label class="filter-option">
                                <input type="checkbox" name="publisher[]" value="{{ $publisher }}"
                                    @checked(in_array($publisher, $selectedPublishers))>
                                <span>{{ $publisher }}</span>
                            </label>
                            @endforeach
                        </div>
            ...
            <div class="results-panel">
                ...
                <div class="empty-state">
                    {{ $hasActiveFilters ? 'No products match your filters.' : 'No products available yet — check back soon.' }}
                </div>
                @else
