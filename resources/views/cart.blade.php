    ...
    <div class="cart-layout">
        ...
        <div class="cart-side">
            <div class="cart-summary-box">
                ...
                <a href="{{ route('checkout.index') }}" class="btn btn-add">Proceed to Checkout &rarr;</a>
                @else
                {{-- User is NOT logged in: Direct them to login and redirect back to checkout after --}}
                <a href="{{ route('login', ['redirect' => route('checkout.index')]) }}" class="btn btn-add">Log in to Checkout &rarr;</a>
                @endauth
            </div>
        </div>
    </div>
