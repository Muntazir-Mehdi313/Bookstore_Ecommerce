...
@section('title', 'Write a Review — ' . ($product->productname ?? $product->name ?? 'Book'))
...
<div class="review-create-page">
    ...
    <a href="{{ url()->previous() }}" style="text-decoration: none; color: #64748b; font-size: 0.9rem;">&larr; Back</a>
    ...
    <div class="review-card">
        ...
        <div class="product-header">
            ...
            <div>
                ...
                <h3 class="product-title">{{ $product->productname ?? $product->name ?? 'Selected Book' }}</h3>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('reviews.store') }}">
            ...
            <div class="form-group">
                ...
                <textarea id="comment" name="comment" rows="5" placeholder="What did you think of this book? Share your thoughts with other readers..." required>{{ old('comment') }}</textarea>
